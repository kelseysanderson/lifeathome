  ...
  return (
    <div className="comment-container">
      ...
      <div className="add-comment-container">
        <form method="post">
          <input ref={textInput} value={formObject.username} onChange={handleInputChange} placeholder="username" className='form-control username-text-area' name="username" placeholder="Name"></input>
