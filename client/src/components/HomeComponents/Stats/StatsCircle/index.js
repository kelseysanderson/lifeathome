        ...
        <Box display="flex" flexDirection="row">
                <Grid item xs={4} >
                    <div>
                        ...
                        <text className="stats-description" dominantBaseline="middle" textAnchor="middle">{props.statBody}<a href={props.statLink} target="_blank" rel="noreferrer"> Read More Here</a></text>
                    </div>
                </Grid>
        </Box>
    )
